...
def main():
    ...
    example_static_input_json, pd_price_json, pd_regionsum_json, dp_json = load_input_data()

    # Step 2: Run the model
    results = run_model(example_static_input_json, pd_price_json, pd_regionsum_json, dp_json)
